...
window.I18N = (function () {
  ...
  const locales = {
    de: {
      ...
      'lang.title': 'Sprache',
      'overview.titleTemplate': 'Zielzeit einstellen ± {range}',
      'time.hourUnit': 'h',
      'time.minuteUnit': 'min',
    ...
    en: {
      ...
      'lang.title': 'Language',
      'overview.titleTemplate': 'Set target time ± {range}',
      'time.hourUnit': 'h',
      'time.minuteUnit': 'min',
    ...
    es: {
      ...
      'lang.title': 'Idioma',
      'overview.titleTemplate': 'Ajustar hora deseada ± {range}',
      'time.hourUnit': 'h',
      'time.minuteUnit': 'min',
    ...
    fr: {
      ...
      'lang.title': 'Langue',
      'overview.titleTemplate': 'Régler l’heure souhaitée ± {range}',
      'time.hourUnit': 'h',
      'time.minuteUnit': 'min',
    ...
    nl: {
      ...
      'lang.title': 'Taal',
      'overview.titleTemplate': 'Gewenste tijd instellen ± {range}',
      'time.hourUnit': 'u',
      'time.minuteUnit': 'min',
    ...
    uk: {
      'program.label': 'Програма',
      'program.ariaLabelWithNumber': 'Програма {number}',
      'theme.toggleAriaLabel': 'Перемкнути світлу/темну тему',
      'theme.title': 'Тема',
      'lang.toggleAriaLabel': 'Змінити мову',
      'lang.title': 'Мова',
      'overview.titleTemplate': 'Налаштувати бажаний час ± {range}',
      'time.hourUnit': 'год',
      'time.minuteUnit': 'хв',
      'wish.label': 'Бажаний час',
      'actual.actualPrefix': 'Фактично ',
      'actual.onTime': 'вчасно',
      'actual.ariaLabelFallback': 'Фактичний час завершення',
      'nav.earlier': 'Раніше',
      'nav.later': 'Пізніше',
      'nav.overviewHint': 'Торкніться, щоб вибрати',
      'day.tomorrowHint': 'завтра',
      'delay.pressCountAriaLabel': 'Кількість натискань',
      'hero.instruction': 'Посудомийна машина: програма й відкладений запуск',
    },
  };
